...
% If using Windows, you MUST NOT provide a deviceNumber.
...
elseif IsWindows
    if exist('deviceNumber','var')
        fprintf('You are using Windows and you MUST NOT provide a deviceNumber! recordKeys will fail.\n');
    end
    while KbCheck end;  % no deviceNumber for Windows
else
    fprintf('**Unidentified OS**\n');
end
